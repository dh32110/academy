...
$( document ).ready(function(){
	...
	var height = <?=$board['bo_gallery_height']?>/<?=$board['bo_gallery_width']?>;
                ...
                <div class="gall_con">
                    <div class="gall_img">
                        ...
                        if ($list[$i]['is_notice']) { // 공지사항  ?>
                            <img src="<?php echo $board_skin_url ?>/img/notice.gif">
                            <?php } else {
                            $v = "";
                            $mov_link = "";
                            $img_content = "";
                            ...
                            if($v){
                            $img_content = '<img src="'.get_yt_thumb( 'http://youtu.be/'.$v, 'sd' ).'" alt="'.$thumb['alt'].'" width="'.$board['bo_gallery_width'].'" height="'.$board['bo_gallery_height'].'">';
                            } 
                            if(!$img_content) {
                            $img_content = '<img src="'.$board_skin_url.'/img/no_image.gif">';
                            }                            
