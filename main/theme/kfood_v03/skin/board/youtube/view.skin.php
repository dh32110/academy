...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h4 id="bo_v_title" class="en1">
            <?php if ($category_name) { ?>
            <span class="bo_v_cate"><?php echo $view['ca_name']; // 분류 출력 끝 ?></span> 
            <?php } ?>
            <div style="background:#eee;border-radius:20px 20px 0 0;padding:10px 0;">
                <span class="bo_v_tit">
                <?php
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong>
    </section>
...
<style type="text/css">
.emb_Utu {position: relative; width: 100%; height: 0; padding-bottom: 56.25%;}
.emb_Utu iframe {position: absolute; top: 0; left: 0; width: 100%; height: 100%}
</style>

<div class="emb_Utu">
            <div class="youtubeWrap">
                <iframe width="728" height="450" src="//www.youtube.com/embed/<?php echo $v; ?>?feature=player_detailpage&vq=hd720" frameborder="0" allowfullscreen></iframe>z
            </div>
</div>
