    ...
    <div x-data="{ open: false }" class="flex flex-col mx-auto lg:items-center justify-between lg:flex-row">
      ...
      <style type="text/css">
        ...
        *{font-family: 'ChosunGs';}
        /*상단로고*/
        .mo1023{display:none;}
        .logomy{width:300px;display:block;} /*PC*/
        ...
        */
        ...
        @media(max-width:414px){
          ...
          .logomy{display:none;} /*PC*/
          .logomy_m{display:block;} /*Mobile*/
          .tBox{width:100%;}
          .gridme4{grid-template-columns:auto;width:100%;max-width:320px;}
          .gridme4 > div{width:100%;max-width:320px;}
        } 
      </style>
<!-- ///////////////////////////////////////////nav include //////////////////////////////////////////////////////////// -->
...
.nanumpenscript * {font-family: 'Nanum Pen Script', cursive;}
  .Vis_sub{height:200px;background: url('<?php echo G5_THEME_IMG_URL ?>/vis_sub1920.jpg') no-repeat center top;text-align:center;position:relative;}
  .Vis_sub_cont{position:absolute;right:500px;top:55px;width:580px;height:100px;}.Vis_sub_cont>h1{font-family: 'DeogonPrincess', cursive;color:black;font-size:50pt;margin:0px;letter-spacing:-3px;}

  @media (max-width:844px){
    .Vis_sub{background-size: 740px; height: 200px; background:#e5dfb6 url('<?php echo G5_THEME_IMG_URL ?>/Vis_sub844.jpg') no-repeat center top;text-align:center;position:relative;}
   
    .Vis_sub_cont{position:absolute;right:215px;top:40px;width:430px;height:100px;font-size:80%;}
   /* 퍼센트로 크기 규정 p, h1 ... */
    .Vis_sub_cont>h1{font-family: 'DeogonPrincess', cursive;color:black;margin:0px;letter-spacing:-3px;}
    /* font-size: 30pt; */
        }
        @media(max-width:414px){
          .Vis_sub{background-size: 414px; height: 170px;background:#e5dfb6 url('<?php echo G5_THEME_IMG_URL ?>/Vis_sub414.jpg') no-repeat center top;text-align:center;position:relative;}
          .Vis_sub_cont{position:absolute;left:58px;top:45px;width:300px;height:100px;font-size:80%;}
          .Vis_sub_cont>h1{font-family: 'DeogonPrincess', cursive;color:black;margin:0px;letter-spacing:-3px;font-size: 20pt;}
          /* background: rgba(0, 0, 0, 0.4); background: rgba(0, 0, 0, 0.4); */
        } 
</style>
<div class="Vis_sub">
  <div class="Vis_sub_cont">
    <h1>한식을 위한 포털</h1>
    <!-- <p>head.php는 서브페이지(게시물,콘텐츠=내용)전체 상단부분 </p> -->
  </div>
</div>
